...
module.exports = function(name) {
	...
	function initNpm(data) {
		...
		exec(`npm i ${data.source}`, (err, result) => {
			...
			const projectPath = `${process.cwd()}/minya`;
